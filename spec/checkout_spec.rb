...
RSpec.describe Checkout do
  ...
  context 'when all pricing rules are enabled' do
    ...
    context 'with enabled config values' do
      ...
      it 'has product_code, minimum_quantity, and discounted_price for BulkDiscountRule' do
      ...
      it 'has product_code, minimum_quantity, and discount_factor for DiscountRule' do
  ...
  context 'when all pricing rules are disabled' do
